...
The following `colors` object is a character vector containing color information for 5 objects. There are only two unique colors present: red and blue. These unique colors are called the **levels** of a factor.
